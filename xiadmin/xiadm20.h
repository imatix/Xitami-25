...
#define XIADM20_L_FILTER_ALIAS              0
#define XIADM20_L_FILTER_AGENT              1
#define XIADM20_KEY                         2
#define XIADM20_FILTER_ALIAS                3
#define XIADM20_FILTER_AGENT                4
#define XIADM20_FILTER_LIST                 5
#define XIADM20_MESSAGE_TO_USER             6
...
static byte xiadm20_blocks [] = {
    ...
    0, 37, 10, 6, 1, 0, 0, 22, 0, 22, 'f', '2', '7', '8', 0, 'F', 'i',
    ...
    0, 40, 10, 6, 1, 0, 0, 25, 0, 25, 'f', '2', '7', '9', 0, 'F', 'i',
    'l', 't', 'e', 'r', 32, 'c', 'o', 'm', 'm', 'a', 'n', 'd', 32, 'o',
    'r', 32, 's', 'c', 'r', 'i', 'p', 't', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 10, 162,
    ...
    '>', 10,
    /*  !--FIELD TEXTUAL f280 NAME=k ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 4, 15, 0, 0, 10, 0, 10, 'f', '2', '8', '0', 0, 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 249,
    /*  !--FIELD TEXTUAL f281 NAME=f ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, 10, 0, 10, 'f', '2', '8', '1', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '6',
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 249,
    /*  !--FIELD TEXTUAL f282 NAME=f ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, '2', 0, '2', 'f', '2', '8', '2', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '6',
    /*  </TR>                                                                */
    0, 4, 1, 0, 10, 234,
    ...
    0, 29, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'f', 'i', 'l', 't',
    'e', 'r', '_', 'l', 'i', 's', 't', 0, '1', '5', 0, 0,
...
static FIELD_DEFN xiadm20_fields [] = {
    { 0, 2683, 22 },                    /*  l_filter_alias                  */
    { 24, 2737, 25 },                   /*  l_filter_agent                  */
    { 51, 2853, 10 },                   /*  key                             */
    { 231, 2885, 10 },                  /*  filter_alias                    */
    { 411, 2914, 50 },                  /*  filter_agent                    */
    { 1191, 2955, 4 },                  /*  filter_list                     */
    { 1197, 2986, 120 },                /*  message_to_user                 */
    { 1319, 0, 0 },                     /*  -- sentinel --                  */
    };
