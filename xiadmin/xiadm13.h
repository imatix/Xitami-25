...
#define XIADM13_L_USER_NAME                 0
#define XIADM13_L_PASSWORD                  1
#define XIADM13_KEY                         2
#define XIADM13_USER_NAME                   3
#define XIADM13_PASSWORD                    4
#define XIADM13_USER_LIST                   5
#define XIADM13_MESSAGE_TO_USER             6
...
static byte xiadm13_blocks [] = {
    ...
    0, 25, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '1', '9', '3', 0, 'U', 's',
    'e', 'r', 32, 'n', 'a', 'm', 'e', ':', 0, 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 24, 10, 6, 1, 0, 0, 9, 0, 9, 'f', '1', '9', '4', 0, 'P', 'a',
    's', 's', 'w', 'o', 'r', 'd', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 10, 177,
    ...
    '>', 10,
    /*  !--FIELD TEXTUAL f195 NAME=k ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '5', 0, 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 248,
    /*  !--FIELD TEXTUAL f196 NAME=u ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '6', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '5',
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 248,
    /*  !--FIELD TEXTUAL f197 NAME=p ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '7', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '5',
    /*  </TR>                                                                */
    0, 4, 1, 0, 10, 233,
    ...
    0, 27, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'u', 's', 'e', 'r',
    '_', 'l', 'i', 's', 't', 0, '1', '5', 0, 0,
...
static FIELD_DEFN xiadm13_fields [] = {
    { 0, 2710, 10 },                    /*  l_user_name                     */
    { 12, 2752, 9 },                    /*  l_password                      */
    { 23, 2852, 20 },                   /*  key                             */
    { 353, 2884, 20 },                  /*  user_name                       */
    { 683, 2913, 20 },                  /*  password                        */
    { 1013, 2954, 4 },                  /*  user_list                       */
    { 1019, 2983, 120 },                /*  message_to_user                 */
    { 1141, 0, 0 },                     /*  -- sentinel --                  */
    };
