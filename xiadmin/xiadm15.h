...
#define XIADM15_L_WSX_ALIAS                 0
#define XIADM15_L_WSX_AGENT                 1
#define XIADM15_KEY                         2
#define XIADM15_WSX_ALIAS                   3
#define XIADM15_WSX_AGENT                   4
#define XIADM15_WSX_LIST                    5
#define XIADM15_MESSAGE_TO_USER             6
...
static byte xiadm15_blocks [] = {
    ...
    0, 25, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '2', '0', '3', 0, 'U', 'R',
    'L', 32, 'a', 'l', 'i', 'a', 's', ':', 0, 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 30, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '2', '0', '4', 0, 'W', 'S',
    'X', 32, 'a', 'g', 'e', 'n', 't', 32, 'n', 'a', 'm', 'e', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 10, 173,
    ...
    '>', 10,
    /*  !--FIELD TEXTUAL f205 NAME=k ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '5', 0, 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 250,
    /*  !--FIELD TEXTUAL f206 NAME=w ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '6', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '7',
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 250,
    /*  !--FIELD TEXTUAL f207 NAME=w ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, '(', 0, '(', 'f', '2', '0', '7', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, '7',
    /*  </TR>                                                                */
    0, 4, 1, 0, 10, 235,
    ...
    0, 26, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'w', 's', 'x', '_',
    'l', 'i', 's', 't', 0, '1', '5', 0, 0,
...
static FIELD_DEFN xiadm15_fields [] = {
    { 0, 2706, 10 },                    /*  l_wsx_alias                     */
    { 12, 2748, 15 },                   /*  l_wsx_agent                     */
    { 29, 2854, 20 },                   /*  key                             */
    { 359, 2886, 20 },                  /*  wsx_alias                       */
    { 689, 2915, 40 },                  /*  wsx_agent                       */
    { 1319, 2956, 4 },                  /*  wsx_list                        */
    { 1325, 2984, 120 },                /*  message_to_user                 */
    { 1447, 0, 0 },                     /*  -- sentinel --                  */
    };
