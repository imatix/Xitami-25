...
#define XIADM14_L_CGI_ALIAS_NAME            0
#define XIADM14_L_CGI_ALIAS_PATH            1
#define XIADM14_KEY                         2
#define XIADM14_CGI_ALIAS_NAME              3
#define XIADM14_CGI_ALIAS_PATH              4
#define XIADM14_CGI_ALIAS_LIST              5
#define XIADM14_MESSAGE_TO_USER             6
...
static byte xiadm14_blocks [] = {
    ...
    0, 25, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '1', '9', '8', 0, 'C', 'G',
    'I', 32, 'a', 'l', 'i', 'a', 's', ':', 0, 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 30, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '1', '9', '9', 0, 'P', 'o',
    'i', 'n', 't', 's', 32, 't', 'o', 32, 'p', 'a', 't', 'h', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 10, 157,
    ...
    '>', 10,
    /*  !--FIELD TEXTUAL f200 NAME=k ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '0', 0, 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 234,
    /*  !--FIELD TEXTUAL f201 NAME=c ... =? UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '1', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, 39,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, 234,
    /*  !--FIELD TEXTUAL f202 NAME=c ... 80 UPPER=0 ATTR="" VALUE=""         */
    0, 15, 10, 0, 15, 0, 0, '2', 0, 'P', 'f', '2', '0', '2', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 11, 39,
    /*  </TR>                                                                */
    0, 4, 1, 0, 10, 219,
...
static FIELD_DEFN xiadm14_fields [] = {
    { 0, 2690, 10 },                    /*  l_cgi_alias_name                */
    { 12, 2732, 15 },                   /*  l_cgi_alias_path                */
    { 29, 2838, 20 },                   /*  key                             */
    { 359, 2870, 20 },                  /*  cgi_alias_name                  */
    { 689, 2899, 80 },                  /*  cgi_alias_path                  */
    { 1919, 2940, 4 },                  /*  cgi_alias_list                  */
    { 1925, 2974, 120 },                /*  message_to_user                 */
    { 2047, 0, 0 },                     /*  -- sentinel --                  */
    };
