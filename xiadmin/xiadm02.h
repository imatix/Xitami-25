...
#define XIADM02_L_FILENAME                  0
#define XIADM02_L_FILEDATE                  1
#define XIADM02_L_FILESIZE                  2
#define XIADM02_FILENAME                    3
#define XIADM02_FILEDATE                    4
#define XIADM02_FILETIME                    5
#define XIADM02_FILESIZE                    6
#define XIADM02_CONFIG_LIST                 7
#define XIADM02_MESSAGE_TO_USER             8
...
static byte xiadm02_blocks [] = {
    ...
    0, 18, 10, 6, 1, 0, 0, 5, 0, 5, 'f', '1', 0, 'N', 'a', 'm', 'e',
    ':', 0, 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    ...
    0, 27, 10, 6, 1, 0, 0, 14, 0, 14, 'f', '2', 0, 'L', 'a', 's', 't',
    32, 'm', 'o', 'd', 'i', 'f', 'i', 'e', 'd', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 9, 170,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 9, 'v',
    /*  !--FIELD TEXTUAL f3 NAME=L_filesize VALUE="Size, lines:"             */
    0, 25, 10, 6, 1, 0, 0, 12, 0, 12, 'f', '3', 0, 'S', 'i', 'z', 'e',
    ',', 32, 'l', 'i', 'n', 'e', 's', ':', 0, 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 9, 170,
    ...
    '>', 10,
    /*  !--FIELD TEXTUAL f4 NAME=fil ... 80 UPPER=0 ATTR="" VALUE=""         */
    0, 13, 10, 10, 15, 0, 0, '(', 0, 'P', 'f', '4', 0, 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, '?',
    /*  !--FIELD DATE f5 NAME=fileda ... TH=? DAY=? ATTR="" VALUE=""         */
    0, 16, 12, 6, 15, 0, 15, 0, 1, 0, 0, 0, 'f', '5', 0, 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 10, 'z',
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, '?',
    /*  !--FIELD TIME f6 NAME=fileti ... E=8 MAX=20 ATTR="" VALUE=""         */
    0, 19, 13, 6, 15, 0, 8, 'f', '6', 0, 0, 'h', 'h', ':', 'm', 'm',
    ':', 's', 's', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 10, 'z',
    /*  <TD ALIGN=LEFT VALIGN=TOP CLASS=tdfield>                             */
    0, 4, 1, 0, 10, '?',
    /*  !--FIELD NUMERIC f7 NAME=fil ... ZE=5 MAX=? ATTR="" VALUE=""         */
    0, 18, 11, 6, 15, 0, 5, 0, 5, 0, 0, 0, 0, 0, 0, 'f', '7', 0, 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 10, 'z',
    /*  </TR>                                                                */
    0, 4, 1, 0, 10, '0',
    ...
    /*  <BR>                                                                 */
    0, 6, 0, '<', 'B', 'R', '>', 10,
    /*  !--ACTION defaults  LABEL="D ... FIRM="" ATTR="" TYPE=BUTTON         */
    0, 37, 20, 0, 1, (byte) ((word) default_event / 256), (byte) ((word)
    ...
    10,
    /*  !--ACTION basehost  LABEL="B ... FIRM="" ATTR="" TYPE=BUTTON         */
    0, 38, 20, 0, 1, (byte) ((word) basehost_event / 256), (byte)
    ...
    0, 29, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'c', 'o', 'n', 'f',
    'i', 'g', '_', 'l', 'i', 's', 't', 0, '1', '5', 0, 0,
...
static FIELD_DEFN xiadm02_fields [] = {
    { 0, 2454, 5 },                     /*  l_filename                      */
    { 7, 2525, 14 },                    /*  l_filedate                      */
    { 23, 2566, 12 },                   /*  l_filesize                      */
    { 37, 2667, 80 },                   /*  filename                        */
    { 1267, 2697, 8 },                  /*  filedate                        */
    { 1417, 2727, 8 },                  /*  filetime                        */
    { 1567, 2760, 5 },                  /*  filesize                        */
    { 1672, 2954, 4 },                  /*  config_list                     */
    { 1678, 2985, 120 },                /*  message_to_user                 */
    { 1800, 0, 0 },                     /*  -- sentinel --                  */
    };
